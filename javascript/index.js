      ...
      getInstruction("mashedPotatoes", 3, (step3) => {
        ...
        getInstruction("mashedPotatoes", 4, (step4) => {
          ...
          getInstruction("mashedPotatoes", 5, (step5) => {
            document.querySelector(
              "#mashedPotatoes"
            ).innerHTML += `<li>${step5}</li>`; // We just added "Mashed potatoes are ready!" onto the data.js - Not sure if this was what we had been asked to do but that was our solution for it.
            document
...
Promise.all(brusselsSproutsArray)
  .then((valuesOfAllPromises) => {
    ...
    valuesOfAllPromises.forEach((element) => {
      brusselsSproutsElement.innerHTML += `<li>${element}</li>`;
    });
    brusselsSproutsElement.innerHTML += `<li>${"Brussel sprouts are ready!"}</li>`;
